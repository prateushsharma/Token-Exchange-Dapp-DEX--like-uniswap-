...
const SwapComponent = () => {
  ...
  useEffect(() => {
    // Handling the text of the submitting button
  ...
  useEffect(() => {
    ...
    // Resetting the isReversed value if it's set
  ...
  return (
    <div className="border-[1px] rounded-l border-[#7765F3] bg-[#7765F3] w-[100%] p-4 px-6 rounded-xl">
      ...
      >
        {srcTokenComp}
        <ArrowSmDownIcon
          className="absolute left-1/2 -translate-x-1/2 -bottom- h-10 p-1 bg-[#212429]
